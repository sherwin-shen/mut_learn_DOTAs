...
if __name__ == '__main__':
    ...
    #pathh= ["6_2_10", "4_2_10", "8_2_10", "10_2_10", "6_2_20", "6_2_50", "6_4_10", "6_6_10"]
    #pathh = ["6_2_10", "4_2_10", '8_2_10', '10_2_10']
    pathh = ["6_2_50"]  #select 重新跑
    #pathh = ["Light"]
    ...
    #for k in range(8):
        for j in range(5):#每个模型跑j遍
            for i in range(1):
                ...
                model_file = "benchmarks/" + mark_name + "/" + mark_name + "-" + str(i + 2) + ".json"
                ...
                #result_path = 'results/' + teacher_type + '/' + 'mutation_g1' + '/' + temp_path
                ...
                result_path = 'results/' + teacher_type + '/' + 'temp_test_select_old' + '/' + temp_path
